#ifndef CONTROLSNAPTOSCALE_H
#define CONTROLSNAPTOSCALE_H
...
namespace Tonality {
	...
	*/
	...
	class ControlSnapToScale : public TemplatedControlConditioner<ControlSnapToScale, Tonality_::ControlSnapToScale_> {
