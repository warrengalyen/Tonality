...
namespace Tonality {
	...
	namespace Tonality_ {
		...
		protected:
			...
			void computeSynthesisBlock(const Tonality::Tonality_::SynthesisContext_ &context);
		...
		public:
			...
			ControlParameter addParameter(string name, TonalityFloat initialValue);
	...
	class Synth : public TemplatedBufferFiller<Tonality_::Synth_> {
	...
	public:
		...
		ControlParameter addParameter(string name, TonalityFloat initialValue = 0.f)
		{
...
#define TONALITY_REGISTER_SYNTH(SynthName)              \
                                              \
