#ifndef CONTROLRECORDER_H
#define CONTROLRECORDER_H
...
namespace Tonality {
	...
	class ControlRecorder : public TemplatedControlConditioner<ControlRecorder, Tonality_::ControlRecorder_> {
	...
	public:
		...
		TONALITY_MAKE_CTRL_GEN_SETTERS(ControlRecorder, mode, setMode)
