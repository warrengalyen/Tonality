...
#pragma mark - Core Generators
	...
	namespace Tonality_ {
		...
		protected:
			...
			virtual void applyFilter(TonalityFloat cutoff, TonalityFloat Q, const SynthesisContext_ & context) = 0;
		...
		protected:
			inline void applyFilter(TonalityFloat cutoff, TonalityFloat Q, const SynthesisContext_ & context)
			{
				...
				TonalityFloat coef = cutoffToOnePoleCoef(cutoff);
				TonalityFloat norm = bNormalizeGain_ ? 1.0f - coef : 1.0f;
		...
		protected:
			...
			inline void applyFilter(TonalityFloat cutoff, TonalityFloat Q, const SynthesisContext_ & context)
			{
				...
				TonalityFloat *inptr = &dryFrames_[0];
				TonalityFloat *outptr = &outputFrames_[0];
				TonalityFloat coef = 1.0f - cutoffToOnePoleCoef(cutoff);
				TonalityFloat norm = bNormalizeGain_ ? 1.0f - coef : 1.0f;
				unsigned int nChannels = dryFrames_.channels();
...
#pragma mark - Smart Pointers
	...
	public:
		...
		TONALITY_MAKE_GEN_SETTERS(FilterType, cutoff, setCutoff);
		TONALITY_MAKE_GEN_SETTERS(FilterType, Q, setQ);
	...
	// LPF 6
	class LPF6 : public TemplatedFilter<LPF6, Tonality_::LPF6_> {};

	// HPF 6
	class HPF6 : public TemplatedFilter<HPF6, Tonality_::HPF6_> {};

	// LPF 12
	class LPF12 : public TemplatedFilter<LPF12, Tonality_::LPF12_> {};

	// LPF 24
	class LPF24 : public TemplatedFilter<LPF24, Tonality_::LPF24_> {};

	// HPF 12
	class HPF12 : public TemplatedFilter<HPF12, Tonality_::HPF12_> {};

	// HPF 24
	class HPF24 : public TemplatedFilter<HPF24, Tonality_::HPF24_> {};

	// BPF 12
	class BPF12 : public TemplatedFilter<BPF12, Tonality_::BPF12_> {};
