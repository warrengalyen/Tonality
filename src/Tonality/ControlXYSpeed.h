#ifndef CONTROLXYSPEED_H
#define CONTROLXYSPEED_H
...
namespace Tonality {
	...
	*/
	...
	class ControlXYSpeed : public TemplatedControlGenerator<Tonality_::ControlXYSpeed_> {

	public:

		TONALITY_MAKE_CTRL_GEN_SETTERS(ControlXYSpeed, x, setX);
		TONALITY_MAKE_CTRL_GEN_SETTERS(ControlXYSpeed, y, setY);
