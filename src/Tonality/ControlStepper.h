...
namespace Tonality {
	...
	class ControlStepper : public TemplatedControlGenerator<Tonality_::ControlStepper_> {

	public:

		TONALITY_MAKE_CTRL_GEN_SETTERS(ControlStepper, start, setStart);
		TONALITY_MAKE_CTRL_GEN_SETTERS(ControlStepper, end, setEnd);
		TONALITY_MAKE_CTRL_GEN_SETTERS(ControlStepper, step, setStep);
		TONALITY_MAKE_CTRL_GEN_SETTERS(ControlStepper, trigger, setTigger);
		TONALITY_MAKE_CTRL_GEN_SETTERS(ControlStepper, bidirectional, setBidirectional);
