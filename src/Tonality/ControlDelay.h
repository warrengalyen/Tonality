#ifndef CONTROLDELAY_H
#define CONTROLDELAY_H
...
namespace Tonality {
	...
	class ControlDelay : public TemplatedControlConditioner<ControlDelay, Tonality_::ControlDelay_> {

	public:

		ControlDelay(float maxDelayTime = 1.0f);
		TONALITY_MAKE_CTRL_GEN_SETTERS(ControlDelay, delayTime, setDelayTimeGen);
